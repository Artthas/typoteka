...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Железо", "Без рамки", "Программирование", "Разное", "Кино", "Психология", "IT", "Природа", "Космос", "Человек", "Музыка", "Животные", "Деревья"`,
      () => expect(response.body).toEqual(
          expect.arrayContaining([`Железо`, `Без рамки`, `Программирование`, `Разное`, `Кино`, `Психология`, `IT`, `Природа`, `Космос`, `Человек`, `Музыка`, `Животные`, `Деревья`])
      )
  );
